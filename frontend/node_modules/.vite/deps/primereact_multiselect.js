...
import { C as classNames, S as ZIndexUtils, _ as DomHandler, b as ObjectUtils, d as ariaLabel, o as PrimeReact, p as localeOption, r as FilterService, s as PrimeReactContext, x as UniqueComponentId, y as IconUtils } from "./api.esm-CaUjrAD0.js";
import { _ as useUpdateEffect, c as useMergeProps, g as useUnmountEffect, i as useDebounce, l as useMountEffect, n as useHandleStyle, t as ComponentBase, u as useOverlayListener } from "./componentbase.esm-B8O_Q2Mt.js";
import { t as SpinnerIcon } from "./index.esm-Cva5edTU.js";
import { t as Ripple } from "./ripple.esm-kG2n_MPK.js";
import { t as Portal } from "./portal.esm-B4cGRk2m.js";
import { t as Tooltip } from "./tooltip.esm-Ds45BQFU.js";
import { t as ChevronDownIcon } from "./index.esm-C2Vx2-gA.js";
import { InputText } from "./primereact_inputtext.js";
import { t as OverlayService } from "./overlayservice.esm-CsU0vMW-.js";
import { t as CSSTransition } from "./csstransition.esm-BdICVRgp.js";
import { t as TimesIcon } from "./index.esm-B6sWWK23.js";
import { n as SearchIcon, t as VirtualScroller } from "./virtualscroller.esm-BF-6CiAf.js";
import { t as CheckIcon } from "./index.esm-Cn3sSizv.js";
import { t as TimesCircleIcon } from "./index.esm-CqkMGEzB.js";
//#region node_modules/primereact/multiselect/multiselect.esm.js
	...
	css: {
		classes: {
			...
			list: function list(_ref4) {
				return _ref4.virtualScrollerOptions ? "p-multiselect-items p-component" : "p-multiselect-items p-component";
			},
		...
		inlineStyles: {
			root: function root(_ref6) {
				...
				return props.showClear && !props.disabled && { position: "relative" };
			},
			itemGroup: function itemGroup(_ref7) {
				var scrollerOptions = _ref7.scrollerOptions;
				return { height: scrollerOptions.props ? scrollerOptions.props.itemSize : void 0 };
			}
		}
	}
});
...
var MultiSelectHeader = /*#__PURE__*/ import_react.memo(function(props) {
	var mergeProps = useMergeProps();
	...
	var getPTOptions = function getPTOptions(key, options) {
		return ptm(key, _objectSpread$3({ hostName: props.hostName }, options));
	};
	...
	var filterElement = function createFilterElement() {
		...
		var filterIcon = IconUtils.getJSXIcon(icon, _objectSpread$3({}, filterIconProps), { props });
		if (props.filter) {
			var filterContainerProps = mergeProps({ className: cx("filterContainer") }, getPTOptions("filterContainer"));
			var content = /*#__PURE__*/ import_react.createElement("div", filterContainerProps, /*#__PURE__*/ import_react.createElement(InputText, {
				ref: props.filterRef,
				type: "text",
				role: "searchbox",
			...
			return /*#__PURE__*/ import_react.createElement(import_react.Fragment, null, content);
		}
		return null;
	}();
	...
	var headerCheckboxIconProps = mergeProps({ className: cx("headerCheckboxIcon") }, getPTOptions("headerCheckbox.icon"));
	var headerCheckboxContainerProps = mergeProps({ className: cx("headerCheckboxContainer") }, getPTOptions("headerCheckboxContainer"));
	var checkedIcon = props.itemCheckboxIcon || /*#__PURE__*/ import_react.createElement(CheckIcon, headerCheckboxIconProps);
	var itemCheckboxIcon = IconUtils.getJSXIcon(checkedIcon, _objectSpread$3({}, headerCheckboxIconProps), { selected: props.selected });
	var checkboxElement = props.showSelectAll && /*#__PURE__*/ import_react.createElement("div", headerCheckboxContainerProps, /*#__PURE__*/ import_react.createElement(Checkbox, {
		id: selectAllId,
		checked: props.selectAll,
		...
		unstyled: isUnstyled()
	}), !props.filter && /*#__PURE__*/ import_react.createElement("label", headerSelectAllLabelProps, props.selectAllLabel));
	var iconProps = mergeProps({
		className: cx("closeIcon"),
		"aria-hidden": true
	}, getPTOptions("closeIcon"));
	var icon = props.closeIcon || /*#__PURE__*/ import_react.createElement(TimesIcon, iconProps);
	var closeIcon = IconUtils.getJSXIcon(icon, _objectSpread$3({}, iconProps), { props });
	...
	var closeElement = /*#__PURE__*/ import_react.createElement("button", closeButtonProps, closeIcon, /*#__PURE__*/ import_react.createElement(Ripple, null));
	var element = /*#__PURE__*/ import_react.createElement("div", headerProps, checkboxElement, filterElement, closeElement);
	if (props.template) {
		var defaultOptions = {
...
var MultiSelectItem = /*#__PURE__*/ import_react.memo(function(props) {
	var _React$useState2 = _slicedToArray(import_react.useState(false), 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
	var checkboxRef = import_react.useRef(null);
	var mergeProps = useMergeProps();
	var ptm = props.ptm, cx = props.cx, isUnstyled = props.isUnstyled;
	...
	var onClick = function onClick(event) {
		if (props.onClick) props.onClick(event, props.option);
		event.preventDefault();
		event.stopPropagation();
	};
	var checkboxIconProps = mergeProps({ className: cx("checkboxIcon") }, getPTOptions("checkbox.icon"));
	var icon = props.checkboxIcon || /*#__PURE__*/ import_react.createElement(CheckIcon, checkboxIconProps);
	var checkboxIcon = props.selected ? IconUtils.getJSXIcon(icon, _objectSpread$2({}, checkboxIconProps), { selected: props.selected }) : null;
	var content = props.template ? ObjectUtils.getJSXElement(props.template, props.option) : props.label;
	var checkboxContainerProps = mergeProps({ className: cx("checkboxContainer") }, getPTOptions("checkboxContainer"));
	...
	return /*#__PURE__*/ import_react.createElement("li", itemProps, /*#__PURE__*/ import_react.createElement("div", checkboxContainerProps, /*#__PURE__*/ import_react.createElement(Checkbox, {
		ref: checkboxRef,
		...
		unstyled: isUnstyled(),
		tabIndex: -1
	})), /*#__PURE__*/ import_react.createElement("span", null, content), /*#__PURE__*/ import_react.createElement(Ripple, null));
});
...
var MultiSelectPanel = /*#__PURE__*/ import_react.memo(/*#__PURE__*/ import_react.forwardRef(function(props, ref) {
	...
	var onEntered = function onEntered() {
		props.onEntered(function() {
			if (props.filter && props.filterInputAutoFocus && filterInputRef.current) DomHandler.focus(filterInputRef.current, false);
		});
	};
	var onFilterInputChange = function onFilterInputChange(event) {
		if (virtualScrollerRef.current) virtualScrollerRef.current.scrollToIndex(0);
	...
	var createHeader = function createHeader() {
		return /*#__PURE__*/ import_react.createElement(MultiSelectHeader, {
			hostName: props.hostName,
			id: props.id,
			filter: props.filter,
	...
	var createFooter = function createFooter() {
		if (props.panelFooterTemplate) {
			...
			return /*#__PURE__*/ import_react.createElement("div", { className: "p-multiselect-footer" }, content);
		}
		return null;
	};
	...
	var createEmptyFilter = function createEmptyFilter() {
		...
		return /*#__PURE__*/ import_react.createElement("li", _extends({}, emptyMessageProps, { key: "emptyFilterMessage" }), emptyFilterMessage);
	};
	var createEmptyContent = function createEmptyContent() {
		var emptyMessage = ObjectUtils.getJSXElement(props.emptyMessage, props) || localeOption("emptyMessage");
		var emptyMessageProps = mergeProps({ className: cx("emptyMessage") }, getPTOptions("emptyMessage"));
		return /*#__PURE__*/ import_react.createElement("li", _extends({}, emptyMessageProps, { key: "emptyMessage" }), emptyMessage);
	};
	var createItem = function createItem(option, index) {
		...
		if (option.group === true && props.optionGroupLabel) {
			...
			return /*#__PURE__*/ import_react.createElement("li", _extends({ key }, itemGroupProps), groupContent);
		}
		var optionLabel = props.getOptionLabel(option);
		var optionKey = index + "_" + props.getOptionRenderKey(option);
		var disabled = props.isOptionDisabled(option);
		var selected = props.isSelected(option);
		return /*#__PURE__*/ import_react.createElement(MultiSelectItem, {
			hostName: props.hostName,
			key: optionKey,
	...
	var createContent = function createContent() {
		if (props.virtualScrollerOptions) {
			...
			return /*#__PURE__*/ import_react.createElement(VirtualScroller, _extends({ ref: virtualScrollerRef }, virtualScrollerProps, {
	...
	var element = function createElement() {
		...
		if (props.inline) return /*#__PURE__*/ import_react.createElement("div", _extends({ ref }, panelProps), content, footer);
		...
		return /*#__PURE__*/ import_react.createElement(CSSTransition, _extends({ nodeRef: ref }, transitionProps), /*#__PURE__*/ import_react.createElement("div", _extends({ ref }, panelProps), /*#__PURE__*/ import_react.createElement("span", firstHiddenElementProps), header, content, footer, /*#__PURE__*/ import_react.createElement("span", lastHiddenElementProps)));
	}();
...
var MultiSelect = /*#__PURE__*/ import_react.memo(/*#__PURE__*/ import_react.forwardRef(function(inProps, ref) {
	var mergeProps = useMergeProps();
	var context = import_react.useContext(PrimeReactContext);
	var props = MultiSelectBase.getProps(inProps, context);
	var _React$useState2 = _slicedToArray(import_react.useState(null), 2), focusedOptionIndex = _React$useState2[0], setFocusedOptionIndex = _React$useState2[1];
	var _React$useState4 = _slicedToArray(import_react.useState(false), 2), clicked = _React$useState4[0], setClicked = _React$useState4[1];
	...
	var _React$useState6 = _slicedToArray(import_react.useState(-1), 2), startRangeIndex = _React$useState6[0], setStartRangeIndex = _React$useState6[1];
	...
	var _React$useState0 = _slicedToArray(import_react.useState(props.inline), 2), overlayVisibleState = _React$useState0[0], setOverlayVisibleState = _React$useState0[1];
	var elementRef = import_react.useRef(null);
	...
	var inputRef = import_react.useRef(props.inputRef);
	var labelContainerRef = import_react.useRef(null);
	var overlayRef = import_react.useRef(null);
	var labelRef = import_react.useRef(null);
	...
	var _useOverlayListener2 = _slicedToArray(useOverlayListener({
		...
		listener: function listener(event, _ref) {
			...
			if (_ref.valid) {
				if (type === "outside") {
					if (!isClearClicked(event) && !isSelectAllClicked(event)) hide();
	...
	var findNearestSelectedOptionIndex = function findNearestSelectedOptionIndex(index) {
		...
		if (hasSelectedOption()) if (firstCheckUp) {
	...
	var onArrowDownKey = function onArrowDownKey(event) {
		if (!overlayVisibleState) {
			...
			if (event.shiftKey) onOptionSelectRange(event, startRangeIndex, optionIndex);
	...
	var onArrowUpKey = function onArrowUpKey(event) {
		...
		if (event.altKey && !pressedInInputText) {
			...
			changeFocusedOptionIndex(event, focusedOptionIndex !== -1 ? findPrevOptionIndex(focusedOptionIndex) : clicked ? findLastOptionIndex() : findLastFocusedOptionIndex());
	...
	var onEnterKey = function onEnterKey(event) {
		...
		} else if (focusedOptionIndex !== -1) if (event.shiftKey) onOptionSelectRange(event, focusedOptionIndex);
	...
	var onHomeKey = function onHomeKey(event) {
		...
		if (pressedInInputText) {
			...
			if (event.shiftKey && metaKey) onOptionSelectRange(event, optionIndex, startRangeIndex);
			changeFocusedOptionIndex(event, optionIndex);
			!overlayVisibleState && show();
		}
		event.preventDefault();
	...
	var onEndKey = function onEndKey(event) {
		...
		if (pressedInInputText) {
			...
			if (event.shiftKey && metaKey) onOptionSelectRange(event, startRangeIndex, optionIndex);
			changeFocusedOptionIndex(event, optionIndex);
			!overlayVisibleState && show();
		}
		event.preventDefault();
	...
	var onSelectAll = function onSelectAll(event) {
		if (props.onSelectAll) props.onSelectAll(event);
		else {
			var value = null;
			if (event.checked) value = [];
				...
				if (validOptions) value = validOptions.map(function(option) {
					return getOptionValue(option);
				});
			}
			if (props.selectionLimit && value && value.length) value = value.slice(0, props.selectionLimit);
	...
	var scrollInView = function scrollInView(event) {
		...
		var focusedItem;
		if (event) focusedItem = event.currentTarget;
		else focusedItem = DomHandler.findSingle(overlayRef.current, "li[data-p-highlight=\"true\"]");
	...
	var getLabelByValue = function getLabelByValue(val) {
		var option;
		if (props.options) if (props.optionGroupLabel) {
			...
			if (ObjectUtils.isEmpty(option)) option = findOptionByValue(val, props.value);
		}
	...
	var isAllSelected = function isAllSelected() {
		if (props.onSelectAll) return props.selectAll;
		if (ObjectUtils.isEmpty(visibleOptions)) return false;
		return !visibleOptions.filter(function(option) {
	...
	var getOptionValue = function getOptionValue(option) {
		...
		if (props.optionValue) return ObjectUtils.resolveFieldData(option, props.optionValue);
	...
	var isOptionDisabled = function isOptionDisabled(option) {
		...
		if (!allowOptionSelect() && !isSelected(option)) return true;
		var optionDisabled = props.optionDisabled;
		if (optionDisabled) return ObjectUtils.isFunction(optionDisabled) ? optionDisabled(option) : ObjectUtils.resolveFieldData(option, optionDisabled);
	...
	var isVisible = function isVisible(element) {
		...
		if (!(parentElement.clientWidth < parentElement.scrollWidth)) return true;
		...
		return target.getBoundingClientRect().right + parseFloat(targetStyles.marginRight) - parentElement.getBoundingClientRect().left <= parentWidth;
	};
	var getSelectedItemsLabel = function getSelectedItemsLabel() {
		...
		if (pattern.test(selectedItemsLabel)) return selectedItemsLabel.replace(selectedItemsLabel.match(pattern)[0], valueLength + "");
		return selectedItemsLabel;
	};
	var getLabel = function getLabel() {
		var _props$value;
		if (empty || props.fixedPlaceholder) return "";
		if (ObjectUtils.isNotEmpty(props.maxSelectedLabels) && ((_props$value = props.value) === null || _props$value === void 0 ? void 0 : _props$value.length) > props.maxSelectedLabels) return getSelectedItemsLabel();
		if (ObjectUtils.isArray(props.value)) return props.value.reduce(function(acc, value, index) {
	...
	var getLabelContent = function getLabelContent() {
		var valueLength = props.value ? props.value.length : 0;
		if (ObjectUtils.isNotEmpty(props.maxSelectedLabels) && valueLength > props.maxSelectedLabels) return getSelectedItemsLabel();
		if (props.selectedItemTemplate) {
			if (!empty) return props.value.map(function(val, index) {
				var item = ObjectUtils.getJSXElement(props.selectedItemTemplate, val);
				return /*#__PURE__*/ import_react.createElement(import_react.Fragment, { key: index }, item);
			});
			return ObjectUtils.getJSXElement(props.selectedItemTemplate);
		}
		if (props.display === "chip" && !empty) return props.value.slice(0, props.maxSelectedLabels || valueLength).map(function(val, i) {
			var context = { context: {
				value: val,
				index: i
			} };
			...
			var icon = !props.disabled && (props.removeIcon ? IconUtils.getJSXIcon(props.removeIcon, _objectSpread({}, iconProps), { props }) : /*#__PURE__*/ import_react.createElement(TimesCircleIcon, iconProps));
			var tokenProps = mergeProps({ className: cx("token") }, ptm("token", context));
			var tokenLabelProps = mergeProps({ className: cx("tokenLabel") }, ptm("tokenLabel", context));
			return /*#__PURE__*/ import_react.createElement("div", _extends({}, tokenProps, { key: labelKey }), /*#__PURE__*/ import_react.createElement("span", tokenLabelProps, label), icon);
		});
		return getLabel();
	};
			...
			if (props.optionGroupLabel) {
				...
				try {
					for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
						...
						if (filteredSubOptions && filteredSubOptions.length) filteredGroups.push(_objectSpread(_objectSpread({}, optgroup), _defineProperty({}, props.optionGroupChildren, filteredSubOptions)));
					}
				} catch (err) {
					_iterator2.e(err);
				} finally {
	...
	import_react.useEffect(function() {
		if (props.overlayVisible === true) show();
		else if (props.overlayVisible === false) hide();
	}, [props.overlayVisible]);
	useUpdateEffect(function() {
		if (overlayVisibleState && filterState && hasFilter) alignOverlay();
	}, [
		overlayVisibleState,
		filterState,
		hasFilter
	...
	var createClearIcon = function createClearIcon() {
		...
		var clearIcon = IconUtils.getJSXIcon(icon, _objectSpread({}, clearIconProps), { props });
		if (!empty && props.showClear && !props.disabled) return clearIcon;
		return null;
	};
	var createLabel = function createLabel() {
		...
		return /*#__PURE__*/ import_react.createElement("div", labelContainerProps, /*#__PURE__*/ import_react.createElement("div", labelProps, content || props.placeholder || props.emptyMessage || "empty"));
	};
	var visibleOptions = getVisibleOptions();
	var hasTooltip = ObjectUtils.isNotEmpty(props.tooltip);
	var otherProps = MultiSelectBase.getOtherProps(props);
	var ariaProps = ObjectUtils.reduceKeys(otherProps, DomHandler.ARIA_PROPS);
	var triggerIconProps = mergeProps({ className: cx("triggerIcon") }, ptm("triggerIcon"));
	var triggerProps = mergeProps({ className: cx("trigger") }, ptm("trigger"));
	var loadingIcon = props.loadingIcon ? IconUtils.getJSXIcon(props.loadingIcon, _objectSpread({}, triggerIconProps), { props }) : /*#__PURE__*/ import_react.createElement(SpinnerIcon, _extends({ spin: true }, triggerIconProps));
	var dropdownIcon = props.dropdownIcon ? IconUtils.getJSXIcon(props.dropdownIcon, _objectSpread({}, triggerIconProps), { props }) : /*#__PURE__*/ import_react.createElement(ChevronDownIcon, triggerIconProps);
	var triggerIcon = /*#__PURE__*/ import_react.createElement("div", triggerProps, props.loading ? loadingIcon : dropdownIcon);
	...
	}, otherProps), {}, { onClick }), MultiSelectBase.getOtherProps(props), ptm("root"));
	var hiddenInputWrapperProps = mergeProps({
		className: "p-hidden-accessible",
		"data-p-hidden-accessible": true
	}, ptm("hiddenInputWrapper"));
	var inputId = import_react.useMemo(function() {
		var _props$inputId;
	...
	return /*#__PURE__*/ import_react.createElement(import_react.Fragment, null, /*#__PURE__*/ import_react.createElement("div", rootProps, /*#__PURE__*/ import_react.createElement("div", hiddenInputWrapperProps, /*#__PURE__*/ import_react.createElement("input", _extends({}, inputProps, { readOnly: true }))), !props.inline && /*#__PURE__*/ import_react.createElement(import_react.Fragment, null, label, clearIcon, triggerIcon), /*#__PURE__*/ import_react.createElement(MultiSelectPanel, _extends({
