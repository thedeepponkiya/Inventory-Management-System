...
export const routeMetaList: RouteMeta[] = [
    ...
    { path: '/sku-master', title: 'SKU Master', subtitle: 'Manage all SKUs / components in your inventory.' },
    { path: '/locations', title: 'Locations (SKU Locations)', subtitle: 'Manage all locations where SKUs are stored in your warehouse.' },
