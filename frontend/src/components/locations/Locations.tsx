...
import { HiOutlinePlus, HiOutlineCheckCircle, HiOutlineTrash, HiOutlineArrowPath, HiOutlineMapPin } from 'react-icons/hi2';
    ...
    return (
        <div className="locations-page">
            ...
            <Dialog
                ...
                header={<DialogHeader icon={HiOutlineMapPin} title={editingId ? 'Edit Location' : 'Add New Location'} />}
