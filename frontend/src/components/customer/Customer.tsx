...
import { getCustomerColumns } from '../../common/commonFunctions/CommonUtilities';
...
const Customer = () => {
    ...
    const { selectedRows, setSelectedRows, handleBulkDelete, bulkDeleting } = useBulkDelete<CustomerType>({
        getId: (row) => row.id,
