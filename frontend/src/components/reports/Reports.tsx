...
// Sales Report and Purchase Report are hidden (per product decision) rather than removed -
// their `hidden: true` just keeps them out of the tab bar below; all of their own
// computation/render code stays fully intact and reachable by flipping this back off.
const TABS: { key: TabKey; label: string; hidden?: boolean }[] = [
    { key: 'stock', label: 'Stock Summary' },
    { key: 'sales', label: 'Sales Report', hidden: true },
    { key: 'purchase', label: 'Purchase Report', hidden: true },
